...
class AnimationLineDefault extends StatefulWidget {
  ...
  @override
  _AnimationLineDefaultState createState() => _AnimationLineDefaultState(key);
}

class _AnimationLineDefaultState extends AnimationLineDefault {
  // _AnimationLineDefaultState();

  Timer _timer;
  List<_ChartData> _chartData;

  _AnimationLineDefaultState(Key key) : super(key);
  @override
